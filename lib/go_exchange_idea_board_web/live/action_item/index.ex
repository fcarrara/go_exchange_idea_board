defmodule GoExchangeIdeaBoardWeb.ActionItemLive.Index do
  ...
  alias GoExchangeIdeaBoardWeb.ActionLiveView
  ...
  def render(assigns), do: ActionLiveView.render("index.html", assigns)

  defp fetch(socket) do
    assign(socket, action_items: ActionItems.list_action_items())
  end

  def handle_event("delete_action_item", id, socket) do
