defmodule GoExchangeIdeaBoard.Retrospectives.Note do
  ...
  alias GoExchangeIdeaBoard.Retrospectives.{NoteGroup, RetroFormatColumn, RetroSession}
  ...
  schema "notes" do
    ...
    belongs_to(:note_group, NoteGroup)
  ...
  def changeset(note, attrs) do
    note
    |> cast(attrs, [:content, :votes, :retro_session_id, :retro_format_column_id])
